...
FormChecker = function(form) {
    ...
    */
    this.FORM_ERROR_MSG = {
       //common   : "입력하신 내용이 규칙에 어긋납니다.\n규칙에 어긋나는 내용을 바로잡아주세요.",
	   common	: "",
       required : " - Please enter this item.",
       notequal : " - These items do not match.",
       invalid  : " - You have entered this incorrectly.",
	   denied   : " - A file type that is not allowed to upload.",
       minbyte  : " - Please enter at least {minbyte} characters",
       maxbyte  : " - Please enter {maxbyte} characters or fewer.",
       min      : " - Value must be at least {min}.",
       max      : " - Value must be less than {max}.",
	   newer    : " - Must be after {sdate}."
    }
...
FormChecker.prototype.func_isNumeric = function(el) {
  ...
  // return (pattern.test(el.value)) ? true : "반드시 숫자로만 입력해야 합니다";
   return (pattern.test(el.value)) ? true : " - Must be numeric only";
}
